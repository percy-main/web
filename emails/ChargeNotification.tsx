...
const Component: FC<Props> = ({
  ...
  <Html>
    <Head />
    <Preview>
      Percy Main Community Sports Club - New Charge: {description}
    </Preview>
    <Body style={styles.main}>
      <Container style={styles.container}>
        ...
        <Text style={styles.paragraph}>
          A new charge has been added to your account:
        </Text>
        <ul>
          <li>
            <em>Description: </em>
        ...
        <Text style={styles.paragraph}>
          You can log in to the members area to view and pay your outstanding
          charges.
        </Text>
...
export const ChargeNotification = email<Props>("New Charge Added", {
  preview: {
...
export default ChargeNotification.component;
