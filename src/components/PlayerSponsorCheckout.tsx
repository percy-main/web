...
const PlayerSponsorCheckoutInner: FC<Props> = ({
  contentfulEntryId,
  playerName,
  playerPhotoUrl,
}) => {
    ...
    return (
      <Card>
        ...
        <CardContent className="flex flex-col gap-3">
          <p>
            Thank you for sponsoring {playerName}! Your sponsorship details will
            be reviewed by our team and displayed on their profile once approved.
          </p>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Sponsor {playerName}</CardTitle>
        {playerPhotoUrl && (
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <Input
            ...
            placeholder='e.g. "Best of luck this season!"'
        ...
        {createPaymentMutation.error && (
          <Alert variant="destructive">
            <AlertDescription>
              {(createPaymentMutation.error as { message?: string })?.message ??
