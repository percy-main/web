...
export type TypeLocationWithoutLinkResolutionResponse = TypeLocation<"WITHOUT_LINK_RESOLUTION">;
export type TypeLocationWithoutUnresolvableLinksResponse = TypeLocation<"WITHOUT_UNRESOLVABLE_LINKS">;
export type TypeLocationWithAllLocalesResponse<Locales extends LocaleCode = LocaleCode> = TypeLocation<"WITH_ALL_LOCALES", Locales>;
export type TypeLocationWithAllLocalesAndWithoutLinkResolutionResponse<Locales extends LocaleCode = LocaleCode> = TypeLocation<"WITHOUT_LINK_RESOLUTION" | "WITH_ALL_LOCALES", Locales>;
export type TypeLocationWithAllLocalesAndWithoutUnresolvableLinksResponse<Locales extends LocaleCode = LocaleCode> = TypeLocation<"WITHOUT_UNRESOLVABLE_LINKS" | "WITH_ALL_LOCALES", Locales>;
