import { A as AstroError, E as EnvInvalidVariables } from './astro/server_W_e1rFCc.mjs';

const schema = {"CDN_TOKEN":{"context":"server","access":"secret","type":"string"},"CDN_SPACE_ID":{"context":"server","access":"secret","type":"string"}};
...
let CDN_TOKEN = _internalGetSecret("CDN_TOKEN");
let CDN_SPACE_ID = _internalGetSecret("CDN_SPACE_ID");

export { CDN_SPACE_ID as C, CDN_TOKEN as a };
